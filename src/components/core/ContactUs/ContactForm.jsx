...
const ContactForm = () => {
  ...
  return (
    <div className='col-span-1 md:col-span-2 border-[1px] border-richblack-700 rounded-xl flex flex-col p-3 lg:p-10 gap-5 lg:gap-10'>
        <div className='flex flex-col gap-3'>
            <p className='font-inter font-semibold text-xl md:text-3xl text-richblack-5'>Got a Idea? We’ve got the skills.<br></br> Let’s team up</p>
            <p className='font-inter text-richblack-200 text-sm md:text-base'>Tall us more about yourself and what you’re got in mind.</p>
        </div>
        <form>
            <div className='flex flex-col gap-5'>
                <div className='grid grid-flow-col grid-cols-1 grid-rows-2 md:grid-rows-1 gap-3 md:grid-cols-2 gap-x-3'>
                    <div className='flex flex-col gap-1'>
                        <label htmlFor='firstName' className='text-richblack-25 font-inter text-sm md:text-base'>First Name</label>
                    ...
                    <div className='flex flex-col gap-1'>
                        <label htmlFor='lastName' className='text-richblack-25 font-inter text-sm md:text-base'>Last Name</label>
                ...
                <div  className='flex flex-col gap-1'>
                        <label htmlFor='email' className='text-richblack-25 font-inter text-sm md:text-base'>Email</label>
                ...
                <div className='flex flex-col gap-2'>
                    <label htmlFor='contactNumber' className='text-richblack-25 font-inter text-sm md:text-base'>Phone Number</label>
                ...
                <div  className='flex flex-col gap-1'>
                        <label htmlFor='message' className='text-richblack-25 font-inter text-sm md:text-base'>Message</label>
